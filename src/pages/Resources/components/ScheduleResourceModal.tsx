...
export const ScheduleResourceModal = ({resource,
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="presentation">
                    ...
                    <div role="dialog" aria-modal="true" aria-labelledby="schedule-modal-title" className="relative w-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl z-10 overflow-hidden flex flex-col max-h-[90vh]">

                        {/* header */}
                        <div className="flex items-center justify-between gap-4 p-5 border-b flex-shrink-0">
                        ...
                        <div className="p-4 border-t bg-white flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 flex-shrink-0">
                            <div className="text-sm text-gray-600">{t('modal_footnote', 'Changes are saved to this resource only')}</div>
                            <div className="flex items-center gap-2">
                                <button onClick={() => { onHandleCancel(); onShowModal(false); }} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-sm">{t('cancel', 'Cancel')}</button>
